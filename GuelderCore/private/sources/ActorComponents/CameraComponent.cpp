...
namespace GuelderEngine
{
    ...
    void CameraComponent::SetViewDirection(const Vector3& position, const Vector3& direction, const Vector3& up)
    {
    ...
    void CameraComponent::SetViewTarget(const Vector3& position, const Vector3& target, const Vector3& up)
    {
        SetViewDirection(position, target - position, up);
    }
    void CameraComponent::SetViewYXZ(const Vector3& position, const Vector3& rotation)
    {
