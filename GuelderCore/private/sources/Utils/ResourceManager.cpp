...
namespace GuelderEngine::Utils
{
    ResourceManager::ResourceManager(const std::string_view& executablePath)
        : path(executablePath.substr(0, executablePath.find_last_of("/\\"))), m_Vars(ResourcesHelper::FindAllVariables(GetRelativeFileSource(resourcesPath))) {}
}
namespace GuelderEngine::Utils
{
